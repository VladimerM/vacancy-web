...
<body>
  ...
  <div class="auth-container container">
    <div class="image">
      <img src="../assets/images/auth-background.png" alt="">
    </div>
    <div class="auth-card" id="loginCard">
      ...
      <div class="social-login">
        <div class="social-login__divider">Or continue with</div>
        <div class="social-buttons">
          ...
          <button class="btn btn-social" onclick="socialLogin('linkedin')">
      ...
      <div class="form-footer">
        <p class="form-footer__text">Don't have an account?</p>
        <a href="#" class="form-footer__link" onclick="showRegister()">Create Account</a>
      </div>
    </div>
    ...
    <div class="auth-card hidden" id="registerCard">
      ...
      <div class="social-login">
        <div class="social-login__divider">Or sign up with</div>
        <div class="social-buttons">
          <button class="btn btn-social" onclick="socialLogin('google')">
            <svg width="18" height="18" viewBox="0 0 24 24">
              <path fill="#4285F4"
      ...
      <div class="form-footer">
        ...
        <a href="#" class="form-footer__link" onclick="showLogin()">Sign In</a>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    document.getElementById('registerPassword')?.addEventListener('input', function (e) {
      ...
      // You could add visual feedback for password strength here
      if (minLength && hasUpper && hasLower && hasNumber) {
        e.target.style.borderColor = '#28a745';
      } else {
        e.target.style.borderColor = '#309689';
      }
    });
